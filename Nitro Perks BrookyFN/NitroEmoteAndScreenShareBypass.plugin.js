//META{"name":"NitroEmoteAndScreenShareBypass","source":"https://github.com/SusAmong/Nitro-Perks","website":"https://github.com/SusAmong"}*//
                        ...
                        if (ext == "gif" || target.parentElement.parentElement.children[0].firstChild.children[1].innerHTML != serverName) {
                            ...
                            useFileUpload ?
                                ...
                                .then(res => res.blob()).then(blob => {
                                    BdApi.findModuleByProps("instantBatchUpload").instantBatchUpload(curChannel, [new File([blob], 'BrookyFN.'+ext, blob)]);
                                }) :
